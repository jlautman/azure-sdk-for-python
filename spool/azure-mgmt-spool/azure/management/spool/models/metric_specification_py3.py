...
class MetricSpecification(Model):
    ...
    :type unit: str
    :param aggregation_type: The method for aggregating the metric. Possible
     values include: 'Average', 'Minimum', 'Maximum', 'Total', 'Count'
    :type aggregation_type: str or
     ~azure.management.spool.models.AggregationType
    ...
    :type dimensions: list[~azure.management.spool.models.Dimension]
    """
    ...
    def __init__(self, *, name: str=None, display_name: str=None, display_description: str=None, unit: str=None, aggregation_type=None, fill_gap_with_zero: str=None, category: str=None, dimensions=None, **kwargs) -> None:
