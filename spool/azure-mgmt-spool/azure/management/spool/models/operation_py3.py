...
class Operation(Model):
    """REST API operation supported by Spool resource provider.

    :param name: Name of the operation with format:
     {provider}/{resource}/{operation}
    :type name: str
    :param display: The object that describes the operation.
    :type display: ~azure.management.spool.models.OperationDisplay
    ...
    :type properties: ~azure.management.spool.models.OperationProperties
    """
